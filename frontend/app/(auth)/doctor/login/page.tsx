...
import { Stethoscope, Lock, Mail, ArrowRight, User, Eye, EyeOff, KeyRound, CheckCircle } from 'lucide-react';
            ...
            <form onSubmit={handleResetPassword} className="space-y-3.5">
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1">
                  Registered Doctor Email Address
                </label>
                <input
                  type="email"
                  required
                  ...
                  placeholder="doctor@example.com"
                  className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 focus:ring-2 focus:ring-sky-600 focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3.5 pr-10 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 focus:ring-2 focus:ring-sky-600 focus:outline-none"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-end gap-2 pt-3">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-sky-700 hover:bg-sky-800 text-white rounded-xl text-sm font-semibold shadow-sm transition"
                >
