...
export default function AdminLoginPage() {
  ...
  const handleAdminLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.detail || 'Admin authentication failed. Please enter the correct password.');
      }
      ...
      if (err.message && err.message.includes('Failed to fetch')) {
        ...
        setError(err.message || 'Admin authentication failed. Incorrect password.');
      }
    } finally {
      setLoading(false);
    }
